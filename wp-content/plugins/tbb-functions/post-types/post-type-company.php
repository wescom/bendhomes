...
// Create metabox for Company CPT using default theme config.
add_filter( 'rwmb_meta_boxes', 'tbb_company_meta_boxes' );
if( !function_exists( 'tbb_company_meta_boxes' ) ) {
    function tbb_company_meta_boxes( $meta_boxes ) {
        ...
        $meta_boxes[] = array(
            ...
            'fields' => array(
				...
				array(
					...
					'desc' => 'Enter office street or mailing address',
					'type' => 'textarea',
					'cols' => '20',
                    'rows' => '4'
				),
