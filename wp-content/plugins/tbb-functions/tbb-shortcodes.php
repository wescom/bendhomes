		...
		<span class="actions">
			<div class="dropdown">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
					...
					<li role="presentation"><a href="javascript:var w = window.open('http://pinterest.com/pin/create/button/?url=<?php echo urlencode($current_url); ?>&media=<?php echo the_post_thumbnail_url('full'); ?>&description=<?php echo urlencode(the_title()); ?>', 'pinterestshare', 'toolbar=0,status=0,scrollbars=1,width=600,height=450'); w.focus();" title="Share on Pinterest"><i class="fa fa-pinterest"></i> Share on Pinterest</a></li>
				</ul>
			</div>
		</span>
