...
function tbb_mortgage_calc_form_js( $atts ) {
	...
	document.getElementById('down-percent').innerHTML = percentdown.toFixed(0)+'%';
	}
	...
	<div class="mort-calc-form-wrap <?php echo $class; ?>" style="margin:30px;border:1px solid #d2d2d2; padding:30px;">
		<div class="mort-calc">
			...
			<p>Down Payment<br>
				<input type=text onkeypress="return validNumber(event)" onKeyUp="return findpercentdown()" name=down size=10 value="<?php echo $down_payment; ?>"> <span id="down-percent"> </span> <span class="smpc-error" id="downError"></span></p>
			<p>Term (in years)?<br>
