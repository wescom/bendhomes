            ...
            'fields' => array(
				...
				array(
                    ...
                    'fields' => array(
						...
						array(
							'id' => "{$prefix}property_crossstreet_addrss",
						...
						array(
							'id' => "{$prefix}property_electric_company",
						...
						array(
							'id' => "{$prefix}property_energy_score",
						...
						array(
							'id' => "{$prefix}property_existing_water",
						...
						array(
							'id' => "{$prefix}property_farm_deferral",
						...
						array(
							'id' => "{$prefix}property_new_construction",
						...
						array(
							'id' => "{$prefix}property_percent_shared",
						...
						array(
							'id' => "{$prefix}property_sellers_disclosure",
						...
						array(
							'id' => "{$prefix}property_sewer_septic",
						...
						array(
							'id' => "{$prefix}property_water_district",
