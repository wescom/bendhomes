...
function siteoptions_options_page()
{
	...
	<div class="wrap" id="truethemes_container">
		...
		<div class="deprecated-notice" style="background: white; border: 2px solid #ec894d; padding: 10px 20px 10px 25px; margin: 0 0 20px 0;">
			<h3>Important Note:</h3>
			<p>
				Theme Options are <em>deprecated</em> in Real Homes version 2.5 and now it comes with a better alternative called <a target="_blank" href="<?php echo $customize_url; ?>">Customizer</a>.
				There is nothing to worry as your all existing theme options are converted to customizer settings.
			</p>
			<p>
				<strong>So, You should no longer use Theme Options as these will be completely removed in Real Homes Version 2.6.</strong>
			</p>
			<p>
				In case of any confusion, You can consult updated documentation and In case of any concern you can reach us through our <a target="_blank" href="http://support.inspirythemes.com/">support site</a>.
			</p>
		</div>
