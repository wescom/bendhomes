<?php // Mailchimp Signup Form used in footer ?>
...
<div class="mc-field-group mc-last">
    ...
    <div class="clear mc-button"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="real-btn btn"></div>
    </div>
</form>
</div>
