<?php
/*
*  Template Name: Import Properties Loop
*/
/*
*  Author: Justin Grady
*/
...
function dbresult($sset) {
  ...
  if(file_exists($fnamerecent)) {
    ...
    $pulldate = strtotime('-5 days'); //'-6 hours' '-1 days'
  }
...
function dataWPinsert($retsproperties) {
...
echo '<h1 style="border: 3px solid orange; padding: 0.25em">import start: '.date(DATE_RSS).'</h1>';
...
echo '<h1 style="border: 3px solid green; padding: 0.25em">import complete: '.date(DATE_RSS).'</h1>';
