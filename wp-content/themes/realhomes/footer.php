...
<div id="mortgage-calculator" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="mortgageCalculator" aria-hidden="true">
    ...
    <div class="modal-body" style="max-height: none; padding: 15px 5px;">
        ...
        <div class="iframe-window">
        	<iframe src="https://0814683845.mortgage-application.net/Calculators/Payment.aspx?oempage=1" width="100%" height="500" scrolling="no" frameborder="0"></iframe>
        </div>
