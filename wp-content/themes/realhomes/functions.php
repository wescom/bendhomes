 ...
 */
define( 'INSPIRY_THEME_VERSION', '2.5.2' );
 ...
 */
require_once( get_template_directory() . '/bend-homes/bh-functions.php' );
...
// Removes WP version number from query string on css/js files
