                ...
                <section class="brands-carousel clearfix">
                    <h3><span><?php echo $partners_title = get_option('theme_partners_title'); ?></span></h3>
                            <div class="row-fluid clearfix">
                                ...
                                <div class="span3 partner"><?php do_action('dfp_ad_spot','partners1'); ?></div>
                                
                                <div class="span3 partner"><?php do_action('dfp_ad_spot','partners2'); ?></div>
                                
                                <div class="span3 partner"><?php do_action('dfp_ad_spot','partners3'); ?></div>
