<?php
/*
*  Template Name: Import Properties Reworked
*/
/*
*  Author: Justin Grady
*/
...
function dataPreProc($proparr,$scenarioset) {
  ...
  foreach($proparr as $propitem) {
    ...
    if($postaction == 'delete_property' || $postaction == 'skip_property') {
      ...
      $propname = 'test1778 - '.$propitem['StreetNumber'].' '.$propitem['StreetNumberModifier'].' '.$propitem['StreetName'].' '.$propitem['StreetSuffix'].', '.$propitem['City'].', '.$propitem['State'].' '.$propitem['ZipCode'];
