                    ...
                    <div id="header-top" class="clearfix">
                        ...
                        if( $enable_user_nav == "true" ){
                            ...
                            <div class="user-nav clearfix">
                                ...
                                <a href="#mortgage-calculator" data-toggle="modal" onClick="ga('send', 'pageview', '<?php echo currentUrl().'&mortcalc=viewed'; ?>');"><i class="fa fa-calculator"></i>Mortgage Calculator</a>
