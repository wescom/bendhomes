...
function child_theme_head_script() { ?>
  <script type='text/javascript'>
	...
	var sizePartners
	  ...
	  sizePartners = [180, 180]
			...
			var slot05 = googletag.defineSlot('/38749147/BendHomes-wideskyscraper2', sizerail, 'div-gpt-ad-' + gadsgenerateId + '-10').addService(googletag.pubads());
  ...
  $(document).ready(function() {
	var ht = $('#leaderBoardContainer').height();
	if (ht < 5) {
		$('#leaderBoardContainer').parent().css("padding", "0px");
	}
  });*/ ?>
function refreshAd(e){googletag.pubads().refresh()}var googletag=googletag||{};googletag.cmd=googletag.cmd||[],function(){var e=document.createElement("script");e.async=!0,e.type="text/javascript";var o="https:"==document.location.protocol;e.src=(o?"https:":"http:")+"//www.googletagservices.com/tag/js/gpt.js";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}(),googletag.cmd.push(function(){var e,o,t,g,a,d=document.documentElement.clientWidth;d>=320&&768>d?(e=[320,50],o=[320,50],t=[320,50],g=[[180,150],[160,600]],a=[180,180]):d>=768&&992>d?(e=[320,50],o=[320,50],t=[320,50],g=[160,600],a=[180,180]):d>=992?(e=[[970,90],[728,90]],o=[728,90],t=[[970,90],[728,90]],g=[160,600],a=[180,180]):(e=[728,90],o=[728,90],t=[728,90],g=[160,600],a=[180,180]);var r=1459980402618,n="Home",i=googletag.defineSlot("/38749147/BendHomes-topLeaderboard",e,"div-gpt-ad-"+r+"-0").addService(googletag.pubads()),s=googletag.defineSlot("/38749147/BendHomes-middleLeaderboard",o,"div-gpt-ad-"+r+"-1").addService(googletag.pubads()),l=googletag.defineSlot("/38749147/BendHomes-Rectangle",g,"div-gpt-ad-"+r+"-2").addService(googletag.pubads()),c=googletag.defineSlot("/38749147/BendHomes-bottomLeaderboard",t,"div-gpt-ad-"+r+"-3").addService(googletag.pubads()),p=googletag.defineSlot("/38749147/BendHomes-wideskyscraper",g,"div-gpt-ad-"+r+"-4").addService(googletag.pubads()),p=googletag.defineSlot("/38749147/BendHomes-wideskyscraper2",g,"div-gpt-ad-"+r+"-10").addService(googletag.pubads());i.setTargeting("section",[n]),l.setTargeting("section",[n]),c.setTargeting("section",[n]),googletag.pubads().collapseEmptyDivs(),googletag.enableServices(),$(window).resize(function(){googletag.pubads().refresh([i,s,l,c,p])})}),$(document).ready(function(){var e=$("#leaderBoardContainer").height();5>e&&$("#leaderBoardContainer").parent().css("padding","0px")});
</script>
