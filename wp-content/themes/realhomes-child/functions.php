...
function child_theme_head_script() { 
  ...
  <script type='text/javascript'>
	...
	googletag.cmd.push(function () {
		...
		var gadssectionkey = "<?php echo(json_encode($sectionKey)); ?>";

		console.log('sectionKey: '.gadssectionkey);
...
//function refreshAd(e){googletag.pubads().refresh()}var googletag=googletag||{};googletag.cmd=googletag.cmd||[],function(){var e=document.createElement("script");e.async=!0,e.type="text/javascript";var o="https:"==document.location.protocol;e.src=(o?"https:":"http:")+"//www.googletagservices.com/tag/js/gpt.js";var g=document.getElementsByTagName("script")[0];g.parentNode.insertBefore(e,g)}(),googletag.cmd.push(function(){var e,o,g,t,a,d,n=document.documentElement.clientWidth;n>=320&&768>n?(e=[320,50],o=[320,50],g=[320,50],t=[[180,150],[160,600]],a=[180,180],d=[300,250]):n>=768&&992>n?(e=[320,50],o=[320,50],g=[320,50],t=[160,600],a=[180,180],d=[300,250]):n>=992?(e=[[970,90],[728,90]],o=[728,90],g=[[970,90],[728,90]],t=[160,600],a=[180,180],d=[300,250]):(e=[728,90],o=[728,90],g=[728,90],t=[160,600],a=[180,180],d=[300,250]);var s=1459980402618,i="<?php echo(json_encode($sectionKey)); ?>";console.log("sectionKey: "+gadssectionkey);var l=googletag.defineSlot("/38749147/BendHomes-topLeaderboard",e,"div-gpt-ad-"+s+"-0").addService(googletag.pubads()),r=googletag.defineSlot("/38749147/BendHomes-middleLeaderboard",o,"div-gpt-ad-"+s+"-1").addService(googletag.pubads()),c=googletag.defineSlot("/38749147/BendHomes-Rectangle",t,"div-gpt-ad-"+s+"-2").addService(googletag.pubads()),p=googletag.defineSlot("/38749147/BendHomes-bottomLeaderboard",g,"div-gpt-ad-"+s+"-3").addService(googletag.pubads());googletag.defineSlot("/38749147/BendHomes-Rectangle",d,"div-gpt-ad-1481219839325-0").addService(googletag.pubads()),googletag.defineSlot("/38749147/BendHomes-something",d,"div-gpt-ad-1481223431350-0").addService(googletag.pubads()),googletag.defineSlot("/38749147/BendHomes-Partners1",a,"div-gpt-ad-"+s+"-5").addService(googletag.pubads()),googletag.defineSlot("/38749147/BendHomes-Partners2",a,"div-gpt-ad-"+s+"-6").addService(googletag.pubads()),googletag.defineSlot("/38749147/BendHomes-Partners3",a,"div-gpt-ad-"+s+"-7").addService(googletag.pubads()),googletag.defineSlot("/38749147/BendHomes-Partners4",a,"div-gpt-ad-"+s+"-8").addService(googletag.pubads()),googletag.defineSlot("/38749147/BendHomes-Partners5",a,"div-gpt-ad-"+s+"-9").addService(googletag.pubads());l.setTargeting("section",[i]),c.setTargeting("section",[i]),p.setTargeting("section",[i]),googletag.pubads().collapseEmptyDivs(),googletag.enableServices(),$(window).resize(function(){googletag.pubads().refresh([l,r,c,p])})});
</script>
