...
if (!function_exists('inspiry_enqueue_child_styles')) {
    function inspiry_enqueue_child_styles(){
        if ( !is_admin() ) {
			...
			wp_enqueue_script( 'superfish', get_stylesheet_directory_uri().'/js/superfish.min.js', array( 'jquery, custom' ), '', true );
			wp_enqueue_script( 'touchswipe', get_stylesheet_directory_uri().'/js/jquery.touchwipe.min.js', array( 'jquery, custom' ), '', true );
			wp_enqueue_script( 'sidr', get_stylesheet_directory_uri().'/js/jquery.sidr.js', array( 'jquery, custom' ), '', true );
			wp_enqueue_script( 'menufit', get_stylesheet_directory_uri().'/js/jquery.menufit.min.js', array( 'jquery, custom' ), '', true );
        }
    }
}
